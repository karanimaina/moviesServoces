...
public class MovieController {
    ...
    public void deleteAllCategory(){
        movieServiceImp.deleteAllCategory();
    }
    ...
    public void deleteAllCoutries(){
        movieServiceImp.deleteAllCountry();
    }
